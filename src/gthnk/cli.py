...
CHROMA_PERSIST_DIR = "{gthnk_path}/chroma"
LLAMA_YOUR_NAME = "Gthnk"
LLAMA_BIG_MODEL_PATH = "~/.ai/models/llama/guanaco-13B.ggmlv3.q4_0.bin"
LLAMA_SMALL_MODEL_PATH = "~/.ai/models/llama/orca-mini-3b.ggmlv3.q4_0.bin"
LLAMA_BINARY_PATH = "~/.ai/bin/llama-latest"
"""
