...
Any text editor that provides macros for the date and time is likely to support **gthnk**.  If you successfully set up another text editor, please `create an issue <https://github.com/iandennismiller/gthnk/issues>`_ that describes your process and we can addit to this document.
